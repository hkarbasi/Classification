...
project_name = 'WomenInEngineering'
...
directory = dict(
    ...
    # master='/Users/habibkarbasian/Documents/Argo/Habib/scratch/_RT/_WomenInEngineering/',
    # save='/Users/habibkarbasian/Documents/Argo/Habib/scratch/_RT/_WomenInEngineering/',
    ...
    dataset=dict(
        ...
        sep='\t',
        filename='#WomenInEngineering-Tweets-Original',
    )
)
features = dict(
    static=dict(
        ...
        liwc=dict(
            type='liwc',
            filename='#WomenInEngineering-Original-LIWC.csv'
        )
    ),
    dynamic=dict(
        bow_text=dict(
